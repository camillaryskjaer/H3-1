...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var assignments = new Assignments(planets);
            
            Console.WriteLine("Opgave 1");
            foreach (var name in assignments.Opgave1())
            {
            ...
            foreach (var name in assignments.Opgave2())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave3())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave4())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave5())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave6())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave7())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave8())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave9())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave10())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave11())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave12())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave13())
            {
                Console.WriteLine(name);
            }
            ...
            var names = assignments.Opgave14();
            ...
            foreach (var name in assignments.Opgave15())
            {
                Console.WriteLine(name);
            }
            ...
            foreach (var name in assignments.Opgave16())
            {
                Console.WriteLine(name);
            }
